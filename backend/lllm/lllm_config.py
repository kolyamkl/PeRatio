...
# Maximum assets per side of the trade (1 = simple pair, no baskets)
MAX_ASSETS_PER_SIDE = 1

# Minimum weight per asset (100% since single asset)
MIN_WEIGHT_PER_ASSET = 1.0
...
# Stop-loss and take-profit limits (LLM decides within range)
MIN_SL_PERCENT = 3       # Minimum stop loss 3%
MAX_SL_PERCENT = 15      # Maximum stop loss 15%
MIN_TP_PERCENT = 5       # Minimum take profit 5%
MAX_TP_PERCENT = 30      # Maximum take profit 30%

# Trade Size Limits (FIXED at $10)
MIN_TRADE_USD = 10       # Fixed trade size in USD
MAX_TRADE_USD = 10       # Fixed trade size in USD
